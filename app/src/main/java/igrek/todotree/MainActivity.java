...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listview = (ListView) content_main.findViewById(R.id.listview1);

        String[] values = new String[]{"Dupa", "Dupa Dupa", "Dupa i fiutek"};
...
//                view.setAlpha(1);
                Snackbar.make(view, "Tekst: "+item, Snackbar.LENGTH_LONG).setAction("Action", null).show();
            }
